...
function validateStepThree() {
  var validation = true;
  if ($('.step:nth-child(3) input[type="text"]').val().indexOf('materialize') === -1) validation = false;
  if ($('.step:nth-child(3) input[type="checkbox"]:checked').length === 0) validation = false;
  return validation;
}

function nextStepThreeHandler() {
  if (validateStepThree()) $('.stepper').nextStep();else {
...
$.fn.nextStep = function (callback, activefb, e) {
  ...
  var feedback = active.find('.next-step').length > 1 ? e ? $(e.target).data("feedback") : undefined : active.find('.next-step').data("feedback"); // If the stepper is parallel, we want to validate the input of the current active step. Not all elements.
...
$.fn.validatePreviousSteps = function () {
  ...
  var index = $(this.children('.step')).index($(active)); // We assume that the validator is set to ignore nothing.
...
$.fn.validateStep = function () {
  var stepper = this.closest('ul.stepper');
  var form = this.closest('form');
  var step = $(this); // Retrieve the custom validator for that step if exists.
...
/***/ "./resources/sass/multi_step.scss":
/*!****************************************!*\
  !*** ./resources/sass/multi_step.scss ***!
  \****************************************/
/*! no static exports found */
...
/***/ 0:
/*!*****************************************************************************************************!*\
  !*** multi ./resources/js/multi_step.js ./resources/sass/app.scss ./resources/sass/multi_step.scss ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\wamp64\www\pwmanager\pwmananger\resources\js\multi_step.js */"./resources/js/multi_step.js");
__webpack_require__(/*! C:\wamp64\www\pwmanager\pwmananger\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\wamp64\www\pwmanager\pwmananger\resources\sass\multi_step.scss */"./resources/sass/multi_step.scss");
